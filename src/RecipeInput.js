...
class RecipeInput extends Component{
	...
	render(){
		...
		return(
		<div>
			<form className="recipeContainer"
			...
			<input type="text" name="title" id="recipeTitle"
			value={title}
			...
			<div className="recipe-form-line">
			<textarea name="instructions" id="recipeInstructions"
			key='instructions'
            type='Instructions'
            rows='8'
            autoComplete='off'
			...
			<input type="text" name="img" id="recipeImage"
			value={img}
			onChange={this.handleChange}/>
			</div>
			<div className="recipe-form-lineR">
